...
// The OrderApplication class which contains the main method, starts the workers, and can create a number of process instances for us to test
...
public class OrderApplication {
    ...
    private static final int WORKER_TIMEOUT = 2; // Set the time for how long a job is exclusively assigned for this
                                                 // worker.
    ...
    public static void main(String[] args) {
        try (final CamundaClient client = CamundaClient.newClientBuilder()
            ...
            final JobWorker PackItemsWorker = client.newWorker()
                    ...
                    .timeout(Duration.ofSeconds(WORKER_TIMEOUT).toMillis())
                    // .fetchVariables("orderId") if you comment this it fetches all variables if
                    // you uncomment only fetches orderId
                    .open();
